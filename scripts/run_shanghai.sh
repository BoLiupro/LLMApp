...
SELECTOR_CKPT="checkpt/shanghai/bestSelector_12.pt"
PREDICTOR_CKPT="checkpt/shanghai/bestPredictor.pt"
CONTINUE_THE_BEST="checkpt/shanghai/bestPredictor.pt"      # 如果要接着上次训练继续，就填上次的 bestPredictor.pt 路径；否则留空

# =========================
# Hyperparameters（按需修改）
# =========================
LONG_SEQ_LEN=64 # should be 128~256, but here we use 64 to save memory
SHORT_SEQ_LEN=12 # 0 6 12 18 24 36 默认 12
KEY_PATTERN_LEN=12 # 0 6 12 18 24 36 默认 12
...
# 数据源（支持目录 / 文件 / 通配符；可多个）
CSV_FILES=(
  "data/processed_data/shanghai/app_usage_records"
...
# ------- vocab/size -------
APP_VOCAB_SIZE=305
LOCATION_VOCAB_SIZE=12576
NUM_APP_CATE=20
NUM_TRAFFIC_BIN=10

# ------- resource paths -------
APP_CATEGORY_CSV="data/processed_data/shanghai/category.csv"
LOCATION_CSV="data/processed_data/shanghai/location.csv"
